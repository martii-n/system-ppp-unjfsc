...
import StudentValidationPanel from "./components/StudentValidationPanel";
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col flex-1 min-h-screen p-4 md:p-6 lg:p-8 gap-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    />
                    <div className="flex items-center gap-2 p-2 px-3 rounded-xl bg-green-500/60 border border-green-500">
                        <ShieldCheck className="size-4" />
                        <span className="text-[10px] font-bold uppercase tracking-widest">Módulo de Control</span>
                    </div>
                </div>
                                ...
                                <TableBody>
                                    {!selectedGroup || !selectedModuleId ? (
                                        ...
                                        filteredStudents.map((student) => {
                                            ...
                                            console.log('Approval status', student.supervision?.approval_status);
